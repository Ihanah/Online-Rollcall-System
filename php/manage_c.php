...
$del = @$_GET['del'];
echo $del;
$delc = mysqli_query($link, "DELETE FROM class where id = '$del'");
                                                ...
                                                <div class="fs-block-header  clearfix">
                                                    <div class="block-title">
                                                        <div style="border-width: 5px; height: 35px; padding: 7px; text-align: center; background-color:#7badcb; font-size: 15.5px">
                                                            <span style="color:#FFFFFF;">教室資料</span>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div style='margin-top:10px; margin-bottom:20px; margin-left:10px; margin-right:10px;'>
                                                                    ...
                                                                    <table width="100%">
                                                                        ...
                                                                        <tbody id="tableId">
                                                                            ...
                                                                            <?php
                                                                                $sql = "SELECT * FROM class where all_class='$getid'";
                                                                                            ...
                                                                                            <div class="modal-dialog">
                                                                                                ...
                                                                                                <div class="modal-content">
                                                                                                    <div class="modal-header">
                                                                                                        ...
                                                                                                        <h3><span class='glyphicon glyphicon-blackboard' aria-hidden='true'><span style="font-family: 'Microsoft JhengHei'; font-weight: bold;">&nbsp;&nbsp;教室資料</span></span></h3>
                                                                                                    </div>
                                                                                                    <div class="modal-body">
                                                                                                        <center>
                                                                                                            <input type="hidden" name="edit_id" value="<?php echo $id?>" placeholder="ID" required>

                                                                                                            <span class='glyphicon glyphicon-blackboard' aria-hidden='true'><span style="font-family: 'Microsoft JhengHei'; font-weight: bold;">&nbsp;教室: </span></span>
                                                                                                            <input type="text" name="edit_class" size="10" value="<?php echo $class?>" placeholder="教室" required>

                                                                                                            <span class='glyphicon glyphicon-arrow-right' aria-hidden='true'><span style="font-family: 'Microsoft JhengHei'; font-weight: bold;">&nbsp;列: </span></span>
                                                                                                            <input type="text" name="edit_width" size="10" value="<?php echo $width?>" placeholder="列" required>

                                                                                                            <span class='glyphicon glyphicon-arrow-down' aria-hidden='true'><span style="font-family: 'Microsoft JhengHei'; font-weight: bold;">&nbsp;行: </span></span>
                                                                                                            <input type="text" name="edit_length" size="10" value="<?php echo $length?>" placeholder="行" required>
                                                                                                        ...
                                                                                                        <script language="javascript">
                                                                                                            function delForm(id) {
                                                                                                                if (confirm("確認刪除此使用者嗎?")) {
                                                                                                                    location.href = "manage_c.php?del=" + id
                                                                                                                    alert("使用者已刪除!");
                                                                                                                }
                                                                                                            }
                                                                            ...
                                                                            <?php 
                                                                                    ...
                                                                                    if(isset($_POST['update_item'])){
                                                                                        ...
                                                                                        $edit_width = $_POST['edit_width'];
                                                                                        $edit_length = $_POST['edit_length'];
                                                                                
                                                                                        $update = "UPDATE class SET 
                                                                                        all_class='$edit_class',
                                                                                        width='$edit_width',
                                                                                        length='$edit_length'
                                                                                
                                                                                        WHERE id='$edit_id'";
                                                                                        if ($link->query($update) === TRUE) {
                                                                                            echo '<script>window.location.href="manage_c.php"</script>';
                                                                                        } else {
